...
class StudentRepositoryTest {
    ...
    void testFindByName() {
        ...
        // able to inquire by method name
        // most used when query sentence is simple
    ...
    @Test
    @DisplayName("test find by city and major")
    ...
    @Test
    @DisplayName("test find by major containing")
    void testFindByMajorContaining() {
        //given
        String major = "수학"; // grammar 'like' will be used so don't need to be same
        ...
        System.out.println("\n\n\n");
        students.forEach(System.out::println); // print all data in the list
        System.out.println("\n\n\n");
    }
    ...
    @Test
    @DisplayName("testSearchByNameWithJPQL")
    void testSearchByNameWithJPQL() {
        //given
        String name = "이";
